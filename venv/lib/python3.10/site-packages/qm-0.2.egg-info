...
Name: qm
Version: 0.2
Summary: Quine-McCluskey two-level logic minimization method.
Home-page: http://robertdick.org/python/mods.html
Author: Robert Dick
Author-email: dickrp@eecs.umich.edu
License: modified Python
Download-URL: http://robertdick.org/python/qm-0.2.tar.gz
